...
public class LeetCodeApiTest {
    ...
    class MockLeetCodeApi extends LeetCodeApi {
        ...
        public List<JSONObject> getLeetCodeProblemList() throws IOException, JSONException {
            ...
            mockData.add(new JSONObject(
                "{\"stat\":{\"question_id\":1, \"question__title\":\"Mock Problem 1\"}, \"paid_only\":false}"));
            mockData.add(new JSONObject(
                "{\"stat\":{\"question_id\":2, \"question__title\":\"Mock Problem 2\"}, \"paid_only\":false}"));
            return mockData;
        }
    }
